...
export default function CartPage() {
	...
	return (<div className="w-full lg:h-[calc(100vh-100px)] bg-primary flex flex-col pt-[25px] items-center">
			<div className="w-[400px] lg:w-[600px] flex flex-col gap-4 ">
				{cart.map((item, index) => {
					return ( <div key={index} className="w-full h-[300px] lg:h-[120px] bg-white flex flex-col lg:flex-row relative items-center p-3 lg:p-0">
                        ...
                        }><BiTrash/></button> <img className="h-[100px] lg:h-full aspect-square object-cover" src={item.image}/>
                        ...
                        </div> <div className="w-[100px] h-full flex flex-row lg:flex-col justify-center items-center ">
                        ...
                        </div> <div className="w-full lg:w-[180px] lg:h-full items-center justify-center  flex flex-row lg:flex-col">
                            {
                                item.labelledPrice>item.price&&<span className="text-secondary lg:w-full   text-center  lg:text-right line-through text-lg pr-[10px] lg:mt-[20px]">LKR {item.labelledPrice.toFixed(2)}</span>
                    ...
                    <div className="h-[50px]">  <span className="font-semibold text-accent lg:w-full text-center   lg:text-right text-2xl p-0 lg:pr-[10px] mt-[5px]">Total: LKR {getTotal().toFixed(2)}</span>
                    </div>
                 </div>
			</div>
		</div>
