...
export default function ProductCard(props) {
	...
	return (<div className="w-[300px] h-[400px] shadow-2xl m-3 flex flex-col p-[10px]">
			...
			<Link state={product} to={"/overview/"+product.productID} className="w-full h-[30px] mt-[5px] border text-center border-accent text-accent hover:bg-accent hover:text-white">
			View product
			</Link>
